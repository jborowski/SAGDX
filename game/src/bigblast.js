var BigBlast = function(conflux, game, x, y, group, facing, speed, startPaused){
  ...
  this.sfx.addMarker('blast', 7, 1, 0.5, false);
  ...
  this.update = function(){
    ...
    if(this.cState.markDestroyed){
      new LittleBlast(this.conflux, this.game, this.x, this.y+16, this.conflux.blasts, this.cState.facing * -1, this.cConstants.speed/gridSize*2, false);
